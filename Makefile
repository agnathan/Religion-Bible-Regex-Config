# This Makefile is for the Religion::Bible::Regex::Config extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Religion/Bible/Regex/Config.pm]
#     AUTHOR => q[Daniel Holmlund <holmlund.dev@gmail.com>]
#     NAME => q[Religion::Bible::Regex::Config]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Test::Base=>q[0], YAML=>q[0], Perl::Critic=>q[0], version=>q[0], Test::Deep=>q[0] }
#     VERSION_FROM => q[lib/Religion/Bible/Regex/Config.pm]
#     clean => { FILES=>q[Religion-Bible-Regex-Config-*] }
...
NAME_SYM = Religion_Bible_Regex_Config
VERSION = 0.6
...
MAKE = make
FULLEXT = Religion/Bible/Regex/Config
BASEEXT = Config
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Religion/Bible/Regex/Config.pm
...
TO_INST_PM = lib/Religion/Bible/Regex/Config.pm

PM_TO_BLIB = lib/Religion/Bible/Regex/Config.pm \
	blib/lib/Religion/Bible/Regex/Config.pm
...
DISTNAME = Religion-Bible-Regex-Config
DISTVNAME = Religion-Bible-Regex-Config-0.6
...
manifypods : pure_all  \
	lib/Religion/Bible/Regex/Config.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Religion/Bible/Regex/Config.pm $(INST_MAN3DIR)/Religion::Bible::Regex::Config.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Religion-Bible-Regex-Config-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Religion-Bible-Regex-Config' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.6' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Creates a configuration object for the Religion::Bible::Regex objects from a YAML file.' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Perl::Critic:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Creates a configuration object for the Religion::Bible::Regex objects from a YAML file.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Daniel Holmlund &lt;holmlund.dev@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Perl-Critic" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Religion/Bible/Regex/Config.pm blib/lib/Religion/Bible/Regex/Config.pm 
